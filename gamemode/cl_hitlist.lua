...
local function DisplayHitlistHUD()
    if targetname ~= nil and alive == 1 and traitor == 1 then
		--basic box
...
usermessage.Hook( "hitman_traitor", SetTraitor )

local function SetInnocent(um)
    traitor = 0
end
usermessage.Hook( "hitman_innocent", SetInnocent )

local function YouAreTraitor(um)
